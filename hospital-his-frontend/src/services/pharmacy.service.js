...
const API_URL = 'http://98.93.152.237:5000/api/v1/pharmacy';
const APPOINTMENT_URL = 'http://98.93.152.237:5000/api/v1/opd/appointments';
const PRESCRIPTION_URL = 'http://98.93.152.237:5000/api/v1/prescriptions';
